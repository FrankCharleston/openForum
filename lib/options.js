document.addEventListener("DOMContentLoaded", function () {
  ...
  const autoDecryptUserIdToggle = document.getElementById("autoDecryptUserIdToggle");
  ...
  chrome.storage.local.get(["autoDecrypt", "defaultPassphrase", "debugMode", "redditUsername", "logs", "autoDecryptUserId"], (data) => {
    ...
    autoDecryptUserIdToggle.checked = data.autoDecryptUserId || false;
  ...
  saveSettings.addEventListener("click", () => {
    ...
    const autoDecryptUserId = autoDecryptUserIdToggle.checked;
