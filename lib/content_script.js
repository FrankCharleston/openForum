...
function attachDebugListeners() {
  document.addEventListener("scroll", () => logDebug("[DEBUG] Scrolling..."), { passive: true });
  document.addEventListener("touchstart", () => logDebug("[DEBUG] Touch detected..."), { passive: true });
  document.addEventListener("wheel", () => logDebug("[DEBUG] Mouse wheel used..."), { passive: true });
}
